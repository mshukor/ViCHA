...
json_path = '/gpfsscratch/rech/dyf/ugz83ue/data/our_albef_data/json_pretrain/cc12m.json'
embeddings_path = '/gpfsscratch/rech/dyf/ugz83ue/data/our_albef_data/clip_da/embeddings/cc12m_keywords_embeddings.json'
output_path ='/gpfsscratch/rech/dyf/ugz83ue/data/our_albef_data/clip_da/json_pretrain/cc12m.json'
data_dir = '/gpfsscratch/rech/dyf/ugz83ue/data'
image_root = None

clip_path = None

max_idx = 7000000
tmp = create_clip_Da_dataset(json_path, embeddings_path, k=15, output_path=output_path, clip_path=clip_path, 
	image_root=image_root, data_dir=data_dir, max_idx=max_idx)
############################################## Flicker
