...
from dataset.caption_dataset import re_train_dataset, re_eval_dataset, pretrain_dataset, pretrain_recipe_dataset
...
def create_recipe_dataset(dataset, config, data_dir='/data/mshukor/data', tokenizer=tokenizer):
    ...
    if dataset=='pretrain':
        dataset = pretrain_recipe_dataset(config['train_file'], pretrain_transform, data_dir=data_dir, tokenizer=tokenizer)                  
        return dataset      
